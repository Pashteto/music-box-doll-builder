...
import (
	...
	"dollbuilder/config"
	"dollbuilder/internal/grpcclient"
	"dollbuilder/internal/http/auth"
	"dollbuilder/internal/http/handlers"
	"dollbuilder/internal/http/middlewares"
...
func (m *Module) initAPI() error {
	...
	// Create API instance
	api := operations.NewDollbuilderAPIAPI(swaggerSpec)
